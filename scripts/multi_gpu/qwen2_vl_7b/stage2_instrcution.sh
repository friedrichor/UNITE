...
# ======================================================================
MODEL_PATH=Unite-Instruct-Qwen2-VL-7B
DATA_PATH=./data/UNITE-Instruct-Data/unite_instruction_tuning.json

RUN_NAME=qwen2vl7b_stage2_lora_r${lora_r}_a${lora_alpha}_temp${temperature}_bs${GLOBAL_BATCH_SIZE}_lr${learning_rate}_ep${num_train_epochs}_pt${PROMPT_VERSION}_max${MAX_FRAMES}f
# ======================================================================
